...
const Services: React.FC<ServicesProps> = ({
  ...
  return (
    <div className="m-7">
      <div
        className={`p-10 flex flex-col lg:flex-row-reverse justify-center align-middle bg-gradient-to-r from-teal-900 via-teal-600 to-teal-300 rounded-3xl`}
      >
        <div className="mt-3 lg:m-16 grid grid-cols-1 gap-7 ">
          ...
          <div className="text-black grid grid-cols-2 gap-1 hover:gap-2 items-center ">
